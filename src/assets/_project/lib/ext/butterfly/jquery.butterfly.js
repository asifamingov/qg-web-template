...
(function ($, ResizeEvents) { // start closure
  ...
  initLightBox = function (options) {
    var pxToEmExists = (typeof Number.prototype.pxToEm !== 'undefined');
  ...
  resizeLightBox = function (callback) {
    var options = $('#jb-overlay').data('options');
    var lbMargin; var availableWidth; var availableHeight; var contentDefaultWidth; var contentDefaultHeight; var mediaMaxWidth; var mediaMaxHeight; var w; var h;
    var reductionRatio; var prevWidth; var topLeft; var animationSpeed; var buttonWidth; var buttonHeight; var buttonLeft; var buttonTop; var prevTop; var prevLeft; var nextTop; var nextLeft;
  ...
  loadLightBoxContent = function (callback) {
    ...
    var caption; var gallerySet; var prevControl; var nextControl; var prevLink; var nextLink;
    var lbMargin; var availableWidth; var availableHeight; var contentDefaultWidth; var contentDefaultHeight; var ajaxHref;
  ...
  $.fn.lightBoxContentWidth = function () {
    ...
    var jbWindowInner = $('#jb-window-inner');
    var isImageType = !!jbWindow.hasClass('type-media');
    var isImageMedia = !!jbWindow.hasClass('media-image');
    var currentWidth = jbWindowInner.width();
    var currentHeight = jbWindowInner.height();
    var currentLeft = jbWindowInner.css('left');
    var currentTop = jbWindowInner.css('top');
    var fullWidth
		;
  ...
  $.fn.lightBoxContentHeight = function (relaxWidth) {
    var jbWindow = this.closest('#jb-window');
    var jbWindowInner = jbWindow.find('#jb-window-inner');
    var isImageType = !!jbWindow.hasClass('type-media');
    var isImageMedia = !!jbWindow.hasClass('media-image');
  ...
  findOffsetToCentre = function (w, h) {
    ...
    var leftOffset = ($(window).width() - w) / 2;
  ...
  $.fn.disableFocussableElements = function (excludeElements) {
    ...
    focussable.each(function () {
      var $this = $(this);
      var prevTabIndex = $this.attr('tabindex')
			;
